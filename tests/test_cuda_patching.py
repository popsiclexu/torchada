...
class TestTorchCudaMemory:
    ...
    def test_memory_pool_functions_match_cpp_ops(self):
        """Test that the injected functions are the same as those in the C++ extension."""
        import torch
        ...
        musa_memory = torch.musa.memory
        assert musa_memory._cuda_beginAllocateCurrentThreadToPool is cpp_ops._cuda_beginAllocateCurrentThreadToPool
        assert musa_memory._cuda_endAllocateToPool is cpp_ops._cuda_endAllocateToPool
        assert musa_memory._cuda_releasePool is cpp_ops._cuda_releasePool
